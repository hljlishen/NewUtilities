...
namespace Utilities.Coordinates
{
    public class PolarCoordinate
    {
        ...
        public static double DistanceBetween(double az1, double el1, double dis1, double az2, double el2, double dis2)
        {
            return new PolarCoordinate(az1, el1, dis1).DistanceTo(new PolarCoordinate(az2, el2, dis2));
        }
